...
import com.tutrieuchau.petbook.Adapter.DoctorHeaderAdapter;
...
public class DoctorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView doctorListView =(ListView) v.findViewById(R.id.doctorListView);
        ArrayList<DoctorHeader> arrayList = new ArrayList<>();
        for(int i = 0; i< 10 ; i++){
            arrayList.add(new DoctorHeader());
        }
        DoctorHeaderAdapter doctorHeaderAdapter = new DoctorHeaderAdapter(getContext(),arrayList);
        doctorListView.setAdapter(doctorHeaderAdapter);
        return v;
    }
